#!/usr/bin/env bash
# 16-managed-p17.sh — protocol-20/current managed Pi/Claude launch contract.
...
step "Dispatch fake Pi through managed protocol-20/current launch"
...
step "Dispatch fake Claude through managed protocol-20/current launch"
