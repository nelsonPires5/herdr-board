...
| Git-root/CWD project identity, independent pipelines/cards, scoped TUI title, and the board picker (`b`) offering the project's `main` board plus `⇄ Other projects…`, which drills to the project picker with Global last | `12-cwd-boards.sh` | live |
