...
| Live catalog | scenarios 01–33; provider-free fake/safe harness boundary | [e2e/README.md](../e2e/README.md) |
...
the scenario catalog lists every `e2e/NN-*.sh` from 01 through 33.
