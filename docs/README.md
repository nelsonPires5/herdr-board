...
| Live catalog | scenarios 01–24; provider-free fake/safe harness boundary | [e2e/README.md](../e2e/README.md) |
...
catalog lists every `e2e/NN-*.sh` from 01 through 24. The provider-free static safety gate is:
