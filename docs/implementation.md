...
is [`../e2e/README.md`](../e2e/README.md), scenarios **01–33** (through `e2e/33-reorder-card-tui.sh`); the safe
...
- E: scenarios `e2e/01-core.sh` through `e2e/33-reorder-card-tui.sh` (real Herdr 0.8.0 / socket
