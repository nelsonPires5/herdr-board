...
is [`../e2e/README.md`](../e2e/README.md), scenarios **01–34** (through `e2e/34-duplicate.sh`); the safe
...
- E: scenarios `e2e/01-core.sh` through `e2e/34-duplicate.sh` (real Herdr 0.8.0 / socket
