...
is [`../e2e/README.md`](../e2e/README.md), scenarios **01–35** (through `e2e/35-rescue-dead-workspace.sh`); the safe
...
- E: scenarios `e2e/01-core.sh` through `e2e/35-rescue-dead-workspace.sh` (real Herdr 0.8.0 / socket
