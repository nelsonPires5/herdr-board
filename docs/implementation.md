...
is [`../e2e/README.md`](../e2e/README.md), scenarios **01–32** (through `e2e/32-managed-opencode.sh`); the safe
...
- E: scenarios `e2e/01-core.sh` through `e2e/32-managed-opencode.sh` (real Herdr 0.8.0 / socket
