...
is [`../e2e/README.md`](../e2e/README.md), scenarios **01–36** (through `e2e/36-multi-project.sh`); the safe
...
- E: scenarios `e2e/01-core.sh` through `e2e/36-multi-project.sh` (real Herdr 0.8.0 / socket
