...
live catalog is `e2e/README.md` (scenarios 01–33); `e2e/test-harness.sh` is the provider-free static
safety gate.
...
- End-to-end: `e2e/run-all.sh` (compat: `scripts/e2e.sh`) drives a REAL Herdr; checked-in fake
  Pi/Claude/Codex/OpenCode executables keep the standard suite (scenarios 01–33) provider-free and zero-cost.
