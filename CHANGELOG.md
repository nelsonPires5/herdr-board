...
- [#77](https://github.com/nelsonPires5/herdr-board/pull/77) fix: Make run completion errors distinguish unknown cards, idle manual cards, and queued configured runs with missing credentials.
