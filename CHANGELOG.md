...
- [#NN](https://github.com/nelsonPires5/herdr-board/pull/NN) feat(tui): `M` (Shift+m) mini-mode to move the focused column (`←`/`→` stage, `Enter` commits one `column.reorder`, `Esc` cancels).
