...
- [#78](https://github.com/nelsonPires5/herdr-board/pull/78) fix: Keep same-board moves quiet while preserving the deprecation warning for cross-board use of the global board selector.
