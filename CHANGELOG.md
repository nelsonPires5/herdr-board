...
- [#80](https://github.com/nelsonPires5/herdr-board/pull/80) feat: reopening a run whose workspace was closed recreates the workspace from the card's space config and resumes there.
