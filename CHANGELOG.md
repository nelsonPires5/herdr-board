...
- [#74](https://github.com/nelsonPires5/herdr-board/pull/74) feat: reorder a card within its column via TUI (`O` mini-mode or same-column drag) and `board card move --position`.
